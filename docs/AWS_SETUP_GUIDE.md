# AWS Setup Guide for FuelLog App

This guide will walk you through setting up AWS S3 for receipt storage and AWS SES for email functionality using the AWS Console (no CLI required).
...
## Part 1: Setting Up S3 Bucket for Receipt Storage
...
4. Configure your bucket:
   - **Bucket name**: `fuel-logbook-receipts` (or your preferred name - must be globally unique)
   - **AWS Region**: Choose your preferred region (e.g., `us-east-1`)
   - **Object Ownership**: Select "ACLs disabled (recommended)"
   - **Block Public Access settings**: 
     - ✅ **UNCHECK** "Block all public access"
     - ⚠️ Acknowledge the warning (we need public read access for receipts)
